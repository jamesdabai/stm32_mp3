...
#define MAX_ALLCODEWORD		400//100//400// //P14,P35 数据容量[码字]* (E) (VER:40), 所有码字为8位
#define MAX_DATACODEWORD	432//80//400// //P27     最大信息码子(Ver：40-L)，所有码字为8位
#define MAX_CODEBLOCK		153	//最大纠错码字 Ver：36.37.38_L_第二块
#define MAX_MODULESIZE		53//37	// 21:Version=1,最大字符=17(8.5个汉字)
								...
								// 53:Version=9,最大字符=230(个汉字)
								// 57:Version=10,最大字符=271(个汉字)
