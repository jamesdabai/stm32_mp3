...
__Vectors       DCD     __initial_sp               ; Top of Stack
                ...
                DCD     0                          ; Reserved
                DCD     OS_CPU_PendSVHandler       ; PendSV Handler ucosiii中的挂起中断，切换任务
...
; Reset handler
Reset_Handler    PROC
                 EXPORT  Reset_Handler             [WEAK];导出该函数标号，外部文件可以当函数调用
        IMPORT  SystemInit								 ;这是外部c语言函数！在这里是复位先进行系统的初始化！然后再跳转到main函数去执行！
        IMPORT  __main
